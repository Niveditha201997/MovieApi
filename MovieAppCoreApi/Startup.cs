...
namespace MovieAppCoreApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AllDbContext>(options=>options.UseSqlServer(connectionStr));
            ...
            services.AddTransient<IShowTimingsRepository, ShowTimingsRepository>();
            services.AddTransient<ShowTimingsService, ShowTimingsService>();
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "Movie API",
                    Description = "Movie Management Sytem API",
                });
